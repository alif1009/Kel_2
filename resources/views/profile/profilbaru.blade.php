...
<div class="flex items-center justify-center min-h-[calc(100vh-130px)]">
 ...
 <!-- Background Decoration (optional) -->
  <img src="{{ asset('images/dekor1.png') }}" alt="dekor"
       class="absolute bottom-0 left-0 w-90 opacity-80 hidden md:block">
  <img src="{{ asset('images/dekor2.png') }}" alt="dekor"
       class="absolute bottom-0 right-0 w-80 opacity-80 hidden md:block">
