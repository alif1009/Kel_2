...
<body class="flex min-h-screen bg-gray-100 font-sans">
  ...
  <aside class="w-64 bg-[#0b3558] text-white flex flex-col">
    ...
    <nav class="flex-1 px-2 py-4 space-y-2">
      <a href="{{ url('stock-peralatan') }}" class="flex items-center gap-3 px-4 py-2 bg-[#f5c16c] text-black rounded-r-full font-semibold">
        <img src="https://img.icons8.com/ios-filled/24/ffffff/home.png" alt="icon" class="w-6 h-6" />
        Dashboard
      </a>
      <a href="{{ url('list-orderan') }}" class="flex items-center gap-3 px-4 py-2 hover:bg-white hover:text-[#0b3558] rounded-r-full transition">
      ...
      <table class="w-full table-auto border-collapse border border-black text-center">
        ...
        <tbody class="bg-white">
          <tr class="h-16">
            ...
            <td class="border border-black">On Going</td>
