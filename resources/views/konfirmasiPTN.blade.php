...
<head>
  <meta charset="UTF-8" />
  <title>Konfirmasi Panitia</title>
...
<body class="flex min-h-screen bg-gray-100 font-sans">
  ...
  <main class="flex-1 p-8">
    <h1 class="text-2xl font-bold mb-4">Konfirmasi Panitia</h1>
      ...
      <table class="w-full table-auto border-collapse border border-black text-center text-lg">
        <thead class="bg-gray-400">
          <tr>
            ...
            <th class="border border-black px-2 py-2">Email</th>
            <th class="border border-black px-2 py-2">KTM</th>
